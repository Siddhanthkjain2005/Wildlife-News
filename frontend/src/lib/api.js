...
export const ENDPOINTS = {
  ...
  predictionsSpecies: withBase("/api/predictions/species"),
  predictionsForecast: withBase("/api/predictions/forecast"),
  predictionsModelInfo: withBase("/api/predictions/model-info"),
