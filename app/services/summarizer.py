        ...
        *,
        ...
        if ollama_enabled:
            ...
            prompt = (
                ...
                "4. 'wpa_schedule': Extracted Indian Wildlife Protection Act 1972 schedule (one of: 'Schedule I', 'Schedule II', 'Schedule III', 'Schedule IV', 'Schedule V', 'Schedule VI', or 'Not Classified'). If not explicitly mentioned in the text, deduce it accurately based on these guidelines: Tigers, Leopards, Elephants, Blackbucks, Pangolins, Peacocks, Hornbills, Sea Turtles, Ganges Dolphins, Asiatic Lions, and Snow Leopards are ALWAYS 'Schedule I'. Jackals, Foxes, Monkeys, Cobras, and Monitor Lizards are 'Schedule II'. Other less endangered wild animals are 'Schedule III' or 'Schedule IV'.\n"
                ...
                "11. 'extracted_suspects': Extract all involved persons, suspects, or perpetrators (e.g. poachers, smugglers, traders, buyers, or arrested individuals) mentioned by name in the article. Provide them as a JSON list of clean, fully capitalized names (e.g. ['Ramesh Kumar', 'Suresh Singh']). Do NOT extract names of forest officers, investigators, police officers, or department officials unless they are themselves accused of a crime.\n"
                "12. 'extracted_species': Extract all animal or plant species mentioned in the article that are victims of poaching, trafficking, seizure, or illegal trade. Provide them as a JSON list of lowercased singular common names (e.g. ['tiger', 'pangolin', 'red sanders']). Translate Hindi/regional names to English (e.g. 'Chital' to 'spotted deer', 'Kala Hiran' to 'blackbuck'). Do NOT include generic terms like 'wildlife', 'animal', 'carcass', 'reptile', or 'bird'.\n"
                "13. 'extracted_location': Identify the exact Indian state and the specific district/forest division where the poaching incident occurred or the seizure was made. Format the output cleanly as 'State, District' (e.g. 'Telangana, Mayurbhanj' or 'Odisha, Baripada'). Do not include general regions."
            )
